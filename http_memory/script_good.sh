...
./http_memory --duration=10m --type=apiserver --port=38080 --certPath=./certs/localhost.crt --keyPath=./certs/localhost.key --sleepDuration=50ms --endpoint=https://localhost:38088 --qps=2000 --poolSize=10 --threshold=100ms &> server.log &
